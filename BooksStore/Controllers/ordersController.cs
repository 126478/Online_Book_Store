...
namespace BooksStore.Controllers
{
    public class ordersController : Controller
    {
        ...
        public ordersController(BooksStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.orders != null ? 
                          ...
                          Problem("Entity set 'BooksStoreContext.orders'  is null.");
        }
...

        {
            ...
            SqlConnection conn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\PC ASUS\\Documents\\mynewdb3.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BooksStoreContext.orders'  is null.");
            }
