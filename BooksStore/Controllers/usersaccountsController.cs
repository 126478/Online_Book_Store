...
namespace BooksStore.Controllers
{
    public class usersaccountsController : Controller
    {
        ...
        public usersaccountsController(BooksStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.usersaccounts != null ? 
                          ...
                          Problem("Entity set 'BooksStoreContext.usersaccounts'  is null.");
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\PC ASUS\\Documents\\mynewdb3.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
